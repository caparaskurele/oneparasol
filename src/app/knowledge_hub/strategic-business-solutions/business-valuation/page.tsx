...
export default async function ValuationIndex() {
  const dir = path.join(process.cwd(), "content", "knowledge-hub", "strategic-business-solutions", "business-valuation");
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        {articles.map((a) => (
          <Link key={a.slug} href={`/knowledge_hub/strategic-business-solutions/business-valuation/${a.slug}`} className="group block border rounded-lg overflow-hidden bg-white">
