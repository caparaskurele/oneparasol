...
export default async function GlobalIndex() {
  const dir = path.join(process.cwd(), "content", "knowledge-hub", "strategic-business-solutions", "global-growth-exports");
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-12">
      ...
      <h1 className="text-3xl font-bold mb-6">Global Growth &amp; Exports</h1>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        {articles.map((a) => (
          <Link key={a.slug} href={`/knowledge_hub/strategic-business-solutions/global-growth-exports/${a.slug}`} className="group block border rounded-lg overflow-hidden bg-white">
