...
export default async function ValueInvestingIndex() {
  const dir = path.join(process.cwd(), "content", "knowledge-hub", "money-markets-mandates", "value-investing");
  ...
  const articles = files.map((file) => {
    ...
    return {
      ...
      image: data?.image || "/img/value-investing.png",
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-12">
      ...
      <h1 className="text-3xl font-bold mb-6">Value Investing</h1>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        {articles.map((a) => (
          <Link key={a.slug} href={`/knowledge_hub/money-markets-mandates/value-investing/${a.slug}`} className="group block border rounded-lg overflow-hidden bg-white">
