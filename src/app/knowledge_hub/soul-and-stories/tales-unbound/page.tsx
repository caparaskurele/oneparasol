...
export default async function TalesUnboundIndex() {
  const dir = path.join(process.cwd(), "content", "knowledge-hub", "soul-and-stories", "tales-unbound");
  ...
  const articles = files.map((file) => {
    ...
    return {
      ...
      image: data?.image || "/img/tales-unbound.png",
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-12">
      ...
      <h1 className="text-3xl font-bold mb-6">Tales Unbound</h1>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        {articles.map((a) => (
          <Link key={a.slug} href={`/knowledge_hub/soul-and-stories/tales-unbound/${a.slug}`} className="group block border rounded-lg overflow-hidden bg-white">
