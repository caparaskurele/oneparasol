...
export default async function SoulfulLivingIndex() {
  const dir = path.join(process.cwd(), "content", "knowledge-hub", "soul-and-stories", "soulful-living");
  ...
  const articles = files.map((file) => {
    ...
    return {
      ...
      image: data?.image || "/img/soulful-living.png",
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-12">
      ...
      <h1 className="text-3xl font-bold mb-6">Soulful Living</h1>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        {articles.map((a) => (
          <Link key={a.slug} href={`/knowledge_hub/soul-and-stories/soulful-living/${a.slug}`} className="group block border rounded-lg overflow-hidden bg-white">
